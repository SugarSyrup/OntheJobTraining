    ...
    <% if(session.getAttribute("id")==null) { %>
        <form class="login_wrapper" action="/sign-up" method="post">
            ...
            <div class="input_wrapper">
                ...
                <input type="password" placeholder="비밀번호를 입력해주세요..." id="password" name="password"  required/>
            </div>
            <div class="input_wrapper">
                <label for="password_check">Password Check</label>
                <input type="password" placeholder="비밀번호를 다시한번 입력해주세요..." id="password_check" name="password_check"  required/>
            </div>
            <div class="input_wrapper">
